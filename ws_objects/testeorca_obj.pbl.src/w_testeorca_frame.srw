$PBExportHeader$w_testeorca_frame.srw
...
string title = "Frame"
string menuname = "m_testeorca_frame"
...
type variables
n_testeorca_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_testeorca_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_testeorca_sheet1", "w_testeorca_sheet2", "w_testeorca_sheet3" }
...
inv_sheetmgt = Create n_testeorca_sheetmanager
